...
Route::get('/users/edit', [\App\Http\Controllers\UserController::class, 'create'])->name('users.edit');
...
Route::get('/brands/{brand}', [\App\Http\Controllers\BrandController::class, 'edit'])->name('brands.edit');
