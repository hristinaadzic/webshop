<footer class="w-100 pink mt-5" id="footer">
    <div class="container">
        <div class="row">

            <div class="col-md-4 pt-5">
                <h2 class="h2 border-bottom pb-3 border-light logo">Safira</h2>
                <ul class="list-unstyled text-light footer-link-list">
                    ...
                    <li>
                        ...
                        <a class="text-decoration-none" href="mailto:safira@company.com">safira@company.com</a>
                    </li>
                </ul>
            </div>
    ...
    <div class="w-100 pink py-3">
        <div class="container">
            <div class="row pt-2">
                <div class="col-12">
                    <p class="text-left text-light">
                        Copyright &copy; 2022
                        | Designed by Hristina Adžić 15/19
                    </p>
                </div>
            </div>
        </div>
